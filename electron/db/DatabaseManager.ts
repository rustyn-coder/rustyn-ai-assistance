...
export class DatabaseManager {
    ...
    private constructor() {
        ...
        this.dbPath = path.join(userDataPath, 'rustyn.db');
        this.init();
    }
...
Rustyn is a real-time AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- Show or hide Rustyn at any time:
  - **Mac**: Cmd + B
  - **Windows**: Ctrl + B
...
- **Usage**: Track your interaction history and see how Rustyn assisted you.
...
### Undetectability
Unlock the **Undetectability** add-on to keep Rustyn invisible during screen sharing.
...
**Once downloaded, return to Settings in Rustyn and select this file to complete setup.**
...
rustyn.contact@gmail.com`;

        const demoMeeting: Meeting = {
            id: demoId,
            title: "Rustyn Demo & Guide",
            date: today.toISOString(),
            duration: "5:00",
            summary: "Complete guide to using Rustyn - your real-time AI meeting assistant.",
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: "Welcome to Rustyn! Let me show you how it works.", timestamp: 0 },
                ...
                { speaker: 'user', text: "How do I hide Rustyn during screen share?", timestamp: 60000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: 'What features does Rustyn have?', answer: 'Rustyn offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.' },
