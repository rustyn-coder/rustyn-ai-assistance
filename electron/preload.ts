...
interface ElectronAPI {
  ...
  authVerify: (data: { token: string }) => Promise<any>;
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  authVerify: (data: { token: string }) =>
    ipcRenderer.invoke("auth:verify", data),
  ...
  generateWhatToSay: (question?: string, imagePath?: string) =>
    ipcRenderer.invoke("generate-what-to-say", question, imagePath),
  ...
  // Window Mode
  setWindowMode: (mode: "launcher" | "overlay") =>
