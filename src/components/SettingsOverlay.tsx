                            ...
                            {activeTab === 'general' && (
                                <div className="space-y-8 animated fadeIn">
                                    <div className="bg-bg-item-surface rounded-xl p-5 border border-border-subtle flex items-center justify-between">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <p className="text-xs text-text-secondary">
                                                Rustyn is currently {isUndetectable ? 'undetectable' : 'detectable'} by screen-sharing. <button className="text-blue-400 hover:underline">Supported apps here</button>
                                            </p>
                                        </div>
                                        <div
                                            onClick={() => {
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <p className="text-xs text-text-secondary mb-4">Customize how Rustyn works for you</p>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h3 className="text-sm font-bold text-text-primary">Open Rustyn when you log in</h3>
                                                        <p className="text-xs text-text-secondary mt-0.5">Rustyn will open automatically when you log in to your computer</p>
                                                    </div>
                                                </div>
                                                <div
                                                    onClick={() => {
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div
                                                    onClick={() => {
                                                        ...
                                                        localStorage.setItem('rustyn_interviewer_transcript', String(newState));
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-text-secondary mt-0.5">Customize how Rustyn looks on your device</p>
                                                    </div>
                                                </div>
                            ...
                            {activeTab === 'keybinds' && (
                                <div className="space-y-5 animated fadeIn select-text h-full flex flex-col justify-center">
                                    <div>
                                        ...
                                        <p className="text-xs text-text-secondary">Rustyn works with these easy to remember commands.</p>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-1">
                                                {[
                                                    ...
                                                    { label: 'Show/Center Rustyn', keys: ['⌘', '⇧', 'Space'], icon: <Layout size={14} /> },
