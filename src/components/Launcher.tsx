  ...
  if (!window.electronAPI) {
    return (
      <div className="text-white p-10">
        Error: Electron API not initialized. Check preload script.
      </div>
    );
  }
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-3 bg-[#101011] border border-border-muted rounded-full px-3 py-1.5 min-w-[140px]">
                        ...
                        <span
                          className={`text-xs font-medium flex-1 transition-colors text-[#B7B7B8]`}
                        >
                    ...
                    >
                      ...
                      <img
                        src={icon}
                        alt="Logo"
                        className="w-[28px] h-[28px] object-contain rounded-full ring-[1.5px] ring-white/30 drop-shadow-[0_1px_4px_rgba(0,0,0,0.4)]"
                      />
                      ...
                      <div className="md:col-span-3 relative group rounded-xl overflow-hidden border border-emerald-500/30 bg-bg-secondary flex flex-col items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-900/40 via-bg-secondary to-bg-secondary">
                        ...
                        <div className="text-center max-w-lg z-10">
                          ...
                          <p className="text-xs text-text-secondary mb-6 flex items-center justify-center gap-2">
                            <Calendar size={12} />
                            {new Date(
                              preparedEvent.startTime,
                            ).toLocaleTimeString([], {
                              hour: "numeric",
                              minute: "2-digit",
                            })}{" "}
                            -{" "}
                            {new Date(preparedEvent.endTime).toLocaleTimeString(
                              [],
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[11px] text-text-tertiary">
                              ...
                              {Math.max(
                                0,
                                Math.ceil(
                                  (new Date(nextMeeting.startTime).getTime() -
                                    Date.now()) /
                                    60000,
                                ),
                              )}{" "}
                      ...
                      <section key={label}>
                        ...
                        <div className="space-y-1">
                          {groupedMeetings[label].map((m) => (
                            ...
                            >
                              <div
                                className={`font-medium text-[14px] max-w-[60%] truncate ${m.title === "Processing..." ? "text-blue-400 italic animate-pulse" : "text-[#F4F4F5]"}`}
                              >
                                {m.title}
                              </div>
                                    ...
                                    <div className="p-1 flex flex-col gap-0.5">
                                      <button
                                        ...
                                        onClick={async () => {
                                          ...
                                          if (
                                            window.electronAPI &&
                                            window.electronAPI.getMeetingDetails
                                          ) {
                                            try {
                                              const fullMeeting =
                                      ...
                                      <button
                                        ...
                                        onClick={async () => {
                                          if (
                                            window.electronAPI &&
                                            window.electronAPI.deleteMeeting
                                          ) {
                                            const success =
        ...
        {showNotification && (
          ...
          >
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-[14px] font-semibold text-white/95 leading-none tracking-tight drop-shadow-md">
                Refreshed
              </span>
              <span className="text-[11px] text-blue-200/60 font-medium leading-none tracking-wide">
